"""
Django settings for nuoxiao project.
...
WSGI_APPLICATION = 'nuoxiao.wsgi.application'
...
# # 是否开启URL访问地址后面不为/跳转至带有/的路径的配置项 ， Django 默认这个参数为 APPEND_SLASH = True。 其作用就是自动在网址结尾加'/'
# APPEND_SLASH=True
...
STATIC_URL = '/statics/'
STATIC_ROOT = os.path.join(BASE_DIR,'..','vacancy','statics')

STATICFILES_DIRS = (
     os.path.join(BASE_DIR, "statics"),
)

# logging 日志配置 新建log文件夹
